...
//		assertThat(petService.findOwnerByPetId(pet7.getId()).getFirstName()).isEqualTo("Jean");
//
//	}
//
//	@Test
...
//		int found = petService.findAllPetsByOwnerId(owner6.getId()).size();
//
//		Pet pet = new Pet();
//		pet.setName("bowser");
...
//		//owner6.addPet(pet);
//		assertThat(petService.findAllPetsByOwnerId(owner6.getId()).size()).isEqualTo(found + 1);
//
//            try {
